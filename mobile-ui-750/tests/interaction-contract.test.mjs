...
test('stateful reference pages expose their required controls', () => {
  const expectations = new Map([
    ...
    ['registration-picker', ['data-action="select-slot"', 'data-action="select-type"', 'data-registration-route="speaker-registration"', 'data-action="registration-submit"']],
    ['speaker-registration', ['class="speaker-form"', 'name="subject"', 'name="introduction"', 'data-action="add-outline"', 'type="file"', 'type="submit"']],
